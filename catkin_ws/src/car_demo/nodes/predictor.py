...
class Predictor:
    def __init__(self):
        ...
        self.net.load_state_dict(torch.load("/home/sdc/self_driving/catkin_ws/src/car_demo/nodes/weights.pt",map_location='cpu'))
        print "loaded"
        self.net.eval()
    ...
    def callback(self,image):
        ...
        t_img = torch.reshape(tensor_img,(3,424,240)).float()
        mean = t_img.mean()
        std = t_img.std()
